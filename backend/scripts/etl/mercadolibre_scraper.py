...
Scraper de alquileres desde MercadoLibre Uruguay. 
Extrae título, ubicación, precio, dorms, baños, superficie, imagen y URL.

Genera: mercadolibre_alquileres_con_imagen.csv
"""
import requests
